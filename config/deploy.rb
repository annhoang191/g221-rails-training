...
set :application, "g221-rails-training"
set :repo_url, "git@github.com:oHoangQuynhAnh/g221-rails-training.git"
server "54.173.146.6", roles: [:web, :app, :db], primary: true
